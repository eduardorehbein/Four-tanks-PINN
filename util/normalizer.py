...
class Normalizer:
    """Neural network data normalizer."""

    def __init__(self, dictionary=None, analysis_axis=0):
        """
        It defines the analysis axis. If it is 0, all class methods will work with row vectors, if it is 1, column
        vectors. It also makes possible the normalizer parameters initialization through a preloaded dictionary.

        :param dictionary: Preloaded dictionary with the normalizer parameters
            (default is None)
